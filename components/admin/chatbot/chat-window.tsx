...
export function Chatbot({ userName }: ChatbotProps) {
  ...
  return (
    <>
      ...
      <Button
        onClick={toggleChat}
        className="fixed bottom-24 md:bottom-6 right-6 z-40 p-4 rounded-full shadow-lg hover:shadow-cyan-500/30"
            ...
            <form onSubmit={handleSubmit} className="p-4 bg-slate-800 border-t border-slate-700">
              <div className="relative">
                ...
                <Button
                  ...
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 text-cyan-500 hover:text-cyan-400 disabled:text-slate-600"
                >
