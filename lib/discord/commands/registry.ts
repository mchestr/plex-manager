 ...
 * the infrastructure the interaction router dispatches against. Migrated/added:
 * `/help` (Step 10), `/mark` (Step 12), `/assistant` (Step 13), and the personal
 * self-service commands `/mymarks`, `/mystats`, `/watching` (Phase 4).
 *
